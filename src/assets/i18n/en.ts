  ...
  public: {
    ...
    Forms: {
      Labels: {
        ...
        Optional: "optional",
        DifferentPerson: "Book for another person",
        FillAtCheckIn: "Fill data subject to reporting requirement upon arrival",
        IsFamilyMember: "Traveling companion is a spouse, partner, or minor child",
        AllAreFamilyMembers: "Travel companions are limited to spouse, domestic partner, or minor children",
      },
      Placeholders: {
      ...
      Errors: {
        Required: {
          ...
          Citizenship: "Please enter the citizenship",
          Street: "Please enter the address",
          PostalCode: "Please enter the ZIP code",
          City: "Please enter the city",
          Country: "Please enter the country",
          BirthDate: "Please enter the date of birth",
          Address: "Please fill out the address fields",
          MainGuestContact: "Please fill out the main guests contact data",
          ReportingRequirement: "Please provide the info for reporting requirements",
        },
        Length: {
