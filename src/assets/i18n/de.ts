  ...
  public: {
    ...
    Rooms: {
      ...
      Extras: {
        ...
        BikeParking: {Label: "Fahrradstellplätze"},
        Motorbike: {Label: "Motorrad"},
        Pets: {Label: "Haustiere"},
        ExtraBed: {Label: "Extrabett"},
        Per: {
          Night: "pro Nacht",
          Guest: "pro Gast",
          Stay: "pro Aufenthalt",
          NightAndGuest: "pro Nacht / pro Gast",
        }
      }
    },
    Contact: {
    ...
    GuestInfo: {
      ...
      ContactDescription: "",
      ReportingRequirement: "Meldepflicht",
      WhyReportingRequirement: "Warum muss ich das ausfüllen?",
      ReportingRequirementDescription: "Gemäß <1>§ 29 und § 30 BMG<2/></1> benötigen wir von Gästen mit nicht-deutscher Staatsbürgerschaft weitere Informationen. Alternativ können Sie diese Informationen auch bei der Ankunft ausfüllen.",
      MainGuest: "Hauptgast",
      Guest_one: "Gast",
      Guest_other: "Gäste"
    },
    CheckOut: {
      Title: "Übersicht",
      PriceForNights: "Preis für {{nights}} Nächte",
      Selection: "Auswahl",
      Total: "Gesamt",
    },
    Imprint: {
    ...
    Forms: {
      Labels: {
        ...
        Optional: "optional",
        DifferentPerson: "Für eine andere Person buchen",
        FillAtCheckIn: "Meldepflichtige Daten bei der Ankunft vor Ort ausfüllen",
        IsFamilyMember: "Mitreisende Person ist ein*e Ehegatt*in, Lebenspartner*in oder ein minderjähriges Kind",
        AllAreFamilyMembers: "Mitreisenden sind ausschließlich Ehegatt*in, Lebenspartner*in oder minderjährige Kinder",
      },
      Placeholders: {
      ...
      Errors: {
        Required: {
          ...
          Phone: "Bitte gülitge Telefonnummer angeben",
          Email: "Bitte gültige E-Mail-Adresse angeben",
          Message: "Bitte geben Sie eine Nachricht ein",
          Citizenship: "Bitte Staatsbürgerschaft angeben",
          Street: "Bitte Adresse angeben",
          PostalCode: "Bitte Postleitzahl angeben",
          City: "Bitte Stadt angeben",
          Country: "Bitte Land angeben",
          BirthDate: "Bitte Geburtsdatum angeben",
          Address: "Bitte Adressdaten vollständig ausfüllen",
          MainGuestContact: "Bitte Angaben des Hauptgasts ausfüllen",
          ReportingRequirement: "Bitte Meldepflichtige Daten ausfüllen",
        },
        Length: {
    ...
    Alerts: {
      GuestDataIncomplete: {
        Title: "Gästeangaben unvollständig",
        Content: "Bitte füllen Sie die notwendigen Angaben aus, um die Buchung abschließen zu können.",
        Action: "Angaben anpassen",
      },
      PricesChanged: {
        Title: "Preise geändert",
        Content: "Bitte beachten Sie die aktualisierten Preise in der folgenden Übersicht.",
      }
    },
    Toast: {
